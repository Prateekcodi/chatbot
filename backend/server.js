        ...
        if (cached && cached.data && cached.data.responses) {
          ...
          if (anyOk) {
            ...
            try {
              ...
              console.error('Supabase save (cached non-stream) failed:', e?.message || e);
            }
            return res.json({
...
Response:`;
      ...
      if (cached && cached.data && cached.data.responses) {
        ...
        if (anyOk) {
          ...
          try {
            ...
            console.error('Supabase save (cached stream) failed:', e?.message || e);
          }

          // Notify frontend immediately that this is a cache hit
    ...
    if (cacheLookupFailed) {
      ...
      console.log('⚠️ No cache found, proceeding with AI calls...');
    }
